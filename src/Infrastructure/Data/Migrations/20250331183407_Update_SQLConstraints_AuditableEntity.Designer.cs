...
namespace CRMBackend.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250331183407_Update_SQLConstraints_AuditableEntity")]
    partial class Update_SQLConstraints_AuditableEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CRMBackend.Domain.AggregateRoots.DodavatelAggregate.Dodavatel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<DateTimeOffset>("UpraveneDna")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("UpravilUzivatel")
                        .HasColumnType("text");

                    b.Property<DateTimeOffset>("VytvoreneDna")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("VytvorilUzivatel")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("CRMBackend.Domain.AggregateRoots.FirmaAggregate.Firma", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CRMBackend.Domain.AggregateRoots.FirmaAggregate.KontaktnaOsoba", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CRMBackend.Domain.AggregateRoots.KategorieProduktovAggregate.KategorieProduktov", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CRMBackend.Domain.AggregateRoots.ObjednavkaAggregate.CenovaPonuka", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CRMBackend.Domain.AggregateRoots.ObjednavkaAggregate.CenovaPonukaTovar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CRMBackend.Domain.AggregateRoots.ObjednavkaAggregate.Objednavka", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("ChybaKlienta")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("CRMBackend.Domain.AggregateRoots.TovarAggregate.Tovar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CRMBackend.Domain.AggregateRoots.TovarAggregate.VariantTovar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CRMBackend.Domain.AggregateRoots.FirmaAggregate.KontaktnaOsoba", b =>
                {
                    b.HasOne("CRMBackend.Domain.AggregateRoots.FirmaAggregate.Firma", "Firma")
            ...
            modelBuilder.Entity("CRMBackend.Domain.AggregateRoots.ObjednavkaAggregate.CenovaPonuka", b =>
                {
                    b.HasOne("CRMBackend.Domain.AggregateRoots.ObjednavkaAggregate.Objednavka", "Objednavka")
            ...
            modelBuilder.Entity("CRMBackend.Domain.AggregateRoots.ObjednavkaAggregate.CenovaPonukaTovar", b =>
                {
                    b.HasOne("CRMBackend.Domain.AggregateRoots.ObjednavkaAggregate.CenovaPonuka", "CenovaPonuka")
                        .WithMany("Polozky")
                        .HasForeignKey("CenovaPonukaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CRMBackend.Domain.AggregateRoots.TovarAggregate.Tovar", "Tovar")
                        .WithMany()
                        .HasForeignKey("TovarId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("CRMBackend.Domain.AggregateRoots.TovarAggregate.VariantTovar", "VariantTovar")
                        .WithMany()
            ...
            modelBuilder.Entity("CRMBackend.Domain.AggregateRoots.ObjednavkaAggregate.Objednavka", b =>
                {
                    ...
                    b.HasOne("CRMBackend.Domain.AggregateRoots.FirmaAggregate.KontaktnaOsoba", "KontaktnaOsoba")
                        .WithMany()
                        .HasForeignKey("KontaktnaOsobaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CRMBackend.Domain.AggregateRoots.ObjednavkaAggregate.CenovaPonuka", "PoslednaCenovaPonuka")
                        .WithOne()
                        .HasForeignKey("CRMBackend.Domain.AggregateRoots.ObjednavkaAggregate.Objednavka", "PoslednaCenovaPonukaId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("CRMBackend.Domain.AggregateRoots.TovarAggregate.Tovar", b =>
                {
                    b.HasOne("CRMBackend.Domain.AggregateRoots.DodavatelAggregate.Dodavatel", "Dodavatel")
                        .WithMany("Tovary")
                        .HasForeignKey("DodavatelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CRMBackend.Domain.AggregateRoots.KategorieProduktovAggregate.KategorieProduktov", "Kategoria")
                        .WithMany()
